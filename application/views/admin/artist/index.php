...
<script>
    ...
    function getAndSetData() {
        ...
        var data = <?=json_encode($listArtist);?>;
            ...
            "aoColumnDefs": [
                {
                    ...
                    "mRender": function (data, type, full) {
                        if (data.length >= 0) {
                            return '<a type="button" id="editCmt" action="update" class="btn btn-warning" href="/artist/update?id=' + data[0] + '">Sửa</a>' +
                                '<a type="button" id="delCmt" action="update" class="btn btn-danger" href="/artist/delete?id=' + data[0] + '">Xóa</a>'
                        }
